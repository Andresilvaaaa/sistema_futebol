        ...
        <Link href="/players">
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Gerenciar Jogadores</h3>
                <p className="text-muted-foreground">Administre o elenco, pagamentos e estatísticas dos atletas</p>
              </div>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/monthly">
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Gestão Mensal</h3>
                <p className="text-muted-foreground">Controle pagamentos mensais e importação de jogadores</p>
              </div>
            </div>
          </Card>
        </Link>
